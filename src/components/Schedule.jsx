  ...
  const myAgenda = [
    {
      ...
      activities: [
        ...
        },
        {
          ...
          description:
            "Opening Ceremony, Keynote Speeches from educational authorities in Cameroon, local administrators, Open Dreams Co-founder, Insights and Discussions on International Education, Training sessions for counselors and high school teachers",
        },
        { time: "12:00 PM - 1:00 PM", description: "Networking Lunch" },
        {
          time: "1:00 PM - 3:30 PM",
          description:
            "Breakout Sessions, Dance Performances & Entertainment Acts, Counselors: Informative Panels",
        },
        {
          time: "3:30 PM - 4:30 PM",
          description: "Group Reporting & Recommendations Sharing",
        },
        {
          time: "4:30 PM - 5:00 PM",
          description: "Closing Remarks & Transition",
        },
      ],
    },
    {
      ...
      activities: [
        {
          ...
          description: "Morning Coffee & Networking",
        },
        {
          time: "9:30 AM - 10:30 AM",
          description: "Keynote Address on International Education",
        },
        {
          time: "10:30 AM - 12:00 PM",
          description:
            "Concurrent Workshops (Various Topics), High School Students: Opportunities & Access, University Students: Graduate-Level Summit",
        },
        ...
        { time: "3:00 PM - 4:30 PM", description: "Essay Writing Contest" },
        {
          ...
          description: "Public Speaking Competition",
        },
    ...
    },
    {
      ...
      activities: [
        ...
        { time: "1:40 PM - 2:00 PM", description: "Arrival of VIPs" },
        {
          ...
          description:
            "Cameroon Anthem, OD Anthem, Keynote Speeches from Diplomatic Bodies, Ministers, Vice Chancellors, and Key Representatives, Panel Discussion with Visiting University Representatives, OD Team, and OD Scholars, Reflection on Open Dreams' 10-Year Journey, Cultural Parade of OD Scholars according to their country of study, Recognition and awards, Networking Lunch and Community Engagement Fair Kickoff",
        },
        {
          time: "4:00 PM - 5:00 PM",
          description: "Gala Ticket Sales & VIP Arrivals",
        },
        {
          time: "5:00 PM - 7:00 PM",
          description:
            "Gala Program, Awards Ceremony: Recognizing Scholars, Mentors, Volunteers, Keynote Speeches & Fundraising Activities",
        },
        {
          time: "7:00 PM - 8:30 PM",
          description: "Gourmet Dinner & Networking",
        },
        {
          time: "8:30 PM - 10:00 PM",
          description: "Live Musical Performances & Entertainment",
        },
        {
          time: "10:00 PM",
          description: "Event Concludes with a Celebratory Toast",
        },
      ],
    },
